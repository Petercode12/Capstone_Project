...
const httpClient = (url, options = {}) => {
  ...
  options.headers.set("access-control-request-headers", "access-control-request-credentials,access-control-request-methods,access-control-request-origin")
  ...
  options.headers.set("access-control-request-methods", "GET,POST,PUT,DELETE,OPTIONS");
...
const App = () => (
  ...
  >
    <Resource name='posts' options={{ label: "Test collection" }} list={ListGuesser} />
    {/* <Resource
      name="users"
